/**
 * lib/crawler shared contract — types copied verbatim from
 * lib/crawler/CONTRACT.md. Every dev agent must keep this file
 * byte-identical across worktrees; the merge step treats it as
 * authoritative.
 */
