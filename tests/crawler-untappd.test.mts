...
class Mock implements CrawlDriver { mode = 'http' as const; calls = 0; async fetchPage(url: string) { this.calls++; return { url, html: url.endsWith('/top') ? top : detail, status: 200, retry_after_ms: null }; } async close() {} }
