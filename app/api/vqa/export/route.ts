...
export async function POST(request: Request) {
  ...
  return NextResponse.json({
    ...
    jsonlPath: "data/vqa-dataset/labeled.jsonl",
    regressionCasesPath: generateRegressionCases
      ? "data/regression-cases.vqa.generated.json"
      : undefined,
  });
}
